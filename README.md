...
   
 ](https://react.dev "https://react.dev")[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAADUlEQVR4nGP4//8/AwAI/AL+p5qgoAAAAABJRU5ErkJggg==)  
   
 ](https://postgresql.org "https://postgresql.org")[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAADUlEQVR4nGP4//8/AwAI/AL+p5qgoAAAAABJRU5ErkJggg==)  
   
 ](https://redis.io "https://redis.io")[![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAADUlEQVR4nGP4//8/AwAI/AL+p5qgoAAAAABJRU5ErkJggg==)  
   
 ](https://docker.com "https://docker.com")[![](data:image/png;base64,)  
   
 ](LICENSE "LICENSE")  
   
 [![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAADUlEQVR4nGP4//8/AwAI/AL+p5qgoAAAAABJRU5ErkJggg==)  
](https://github.com/mailtkarim-bot/AI_Receptionist_Pro "https://github.com/mailtkarim-bot/AI_Receptionist_Pro")  
**AI Voice · SMS · WhatsApp · Email · Google Calendar · Web3 USDC · JWT + Redis · Docker**  
[📐 Architecture · ](#anchor-1 "#anchor-1")[🚀 Quick Start · ](#anchor-2 "#anchor-2")[💰 Business Model Research · ](#anchor-3 "#anchor-3")[🔐 Security · ](#anchor-4 "#anchor-4")[📞 Contact](#anchor-5 "#anchor-5")  
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANElEQVR4nO3OQQmAUBBAwSf8FGLYbWFCU3ixgjcRZhLMNjNHdQYAwF9cq1rV/vUEAIDX7gck6AQ37gisMAAAAABJRU5ErkJggg==)  
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANklEQVR4nO3OQQmAABRAsSdYxZ4/jGXsYAKPJrCCNxG2BFtmZquOAAD4i3Ot7mr/egIAwGvXA55ZBdAkO/TwAAAAAElFTkSuQmCC)  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAM0lEQVR4nO3OUQmAQBBAwSdcjAu7KWxoDMEK/okwk2COmdnVGQAAf3GtalX76wkAAK/dDyTiBDpzYBhBAAAAAElFTkSuQmCC)  
**Overview**  
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OQQmAABRAsSd49Ww1ywi/qAVMYQVvImwJtszMXp0BAPAX91pt1fH1BACA164HrGUERt3CrQAAAAAASUVORK5CYII=)  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OMQ2AABAAsSPBCE7fE2YYmRDBhAU2QtIq6DIzW7UHAMBfnGt1V8fXEwAAXrseEqQF8tIoBGsAAAAASUVORK5CYII=)  
**Features**  
| | | | | |  
|-|-|-|-|-|  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OQQmAABRAsSd4NICpzPQNagBbWMGbCFuCLTOzV2cAAPzFvVZbdXw9AQDgtesBmQoEP/Dt+QgAAAAASUVORK5CYII=)  
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAM0lEQVR4nO3OUQmAABBAsSdoCsGsl8KI1tAK/omwJdgyM3t1BgDAX1xrtVXH1xMAAF67HzhfBD8b2m5SAAAAAElFTkSuQmCC)  
**Architecture**  
┌─────────────────────────────────────────────────────────────────────────────┐  
 │                              CLIENT LAYER                                    │  
 │  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────────┐  │  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANklEQVR4nO3OQQmAABRAsSdYxZ4/iYmMYANPNrCCNxG2BFtmZquOAAD4i3Ot7mr/egIAwGvXA5SxBc1hqF7TAAAAAElFTkSuQmCC)  
**Quick Start**  
**Prerequisites**  
- Docker 24+  
- Docker Compose 2.20+  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANklEQVR4nO3OMQ2AABAAsSNBCUpfFwpwwYoDViywEZJWQZeZ2ao9AAD+4lyruzq+ngAA8Nr1AOvSBehC4jC0AAAAAElFTkSuQmCC)  
**API Endpoints**  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANElEQVR4nO3OQQmAABRAsSeYw6w/jcUsoSet4E2ELcGWmdmqPQAA/uJYq7s6v54AAPDa9QBgQgYdDj2VcAAAAABJRU5ErkJggg==)  
**Security**  
**Authentication**  
...
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OMQ2AUBBAsUfyRTAg9mRgEBFsWGAjJK2CbjNzVGcAAPzFtapV7V9PAAB47X4AJO4END4od0kAAAAASUVORK5CYII=)  
...
     await db.commit()  
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANklEQVR4nO3OMQ2AABAAsSNhQAM6EPgC8MiIDSywEZJWQZeZ2aszAAD+4l6rrTq+ngAA8Nr1AF7sBC58qCAcAAAAAElFTkSuQmCC)  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAAMUlEQVR4nO3WQQ0AIAwEsCPBCUanDCm8UcAbHUtaFR1VtZLsAADQxZlJXiQOAKCT+wHYdwXh388BewAAAABJRU5ErkJggg==)  
**CI/CD Pipeline**  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANElEQVR4nO3OQQmAABRAsad4EDvY9ScxnUGs4E2ELcGWmTmrKwAA/uLeqrU6vp4AAPDa/gAG8QM5DXsrCgAAAABJRU5ErkJggg==)  
...
   
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OQQmAABRAsScYxKi/koUEL5bwYgVvImwJtszMVu0BAPAX51rd1fH1BACA164HJg8F99RDbTYAAAAASUVORK5CYII=)  
**Changelog**  
...
- Prometheus metrics  
- Backup scripts  
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANUlEQVR4nO3OMQ2AABAAsSNhQQJm0PYjLlmRgQU2QtIq6DIze3UGAMBf3Gu1VcfXEwAAXrseckcENepnbxwAAAAASUVORK5CYII=)  
**Project Structure**  
ai-receptionist/  
...
**Check out **[ **AI Receptionist Pro**  
   
 The same core technology, packaged for rapid freelance deployment.](https://github.com/mailtkarim-bot/AI_Receptionist_Pro "https://github.com/mailtkarim-bot/AI_Receptionist_Pro")  
![](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAnEAAAACCAYAAAA3pIp+AAAABmJLR0QA/wD/AP+gvaeTAAAACXBIWXMAAA7EAAAOxAGVKw4bAAAANklEQVR4nO3OMQ2AABAAsSNBABMqGRHwPpGACSywEZJWQZeZ2aszAAD+4l6rrTq+ngAA8Nr1ANMYBFJXi/YHAAAAAElFTkSuQmCC)  
**Contributing**  
