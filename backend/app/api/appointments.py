"""Appointments router avec SELECT FOR UPDATE + validations.

Corrections Némésis:
- SELECT FOR UPDATE (race condition)
- end_time > start_time validation
- start_date/end_date DateTime parsing
"""
...
async def create_appointment(
    ...
    # EC-02: end_time doit être après start_time
    ...
    # CRIT-09: Verrou pessimiste avec SELECT FOR UPDATE
    async with db.begin():
        ...
        if conflict.scalar_one_or_none():
            raise HTTPException(
                ...
                detail="Conflit de créneau horaire",
            )
...
async def get_calendar_view(
    ...
    # EC-01: Parse str to datetime for comparison
    try:
