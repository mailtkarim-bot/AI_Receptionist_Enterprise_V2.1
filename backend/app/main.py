"""AI Receptionist Enterprise — FastAPI Application Entry Point.

Production-ready with security middleware, monitoring, and GDPR lifecycle.
"""
...
@app.get("/")
async def root():
    return {"name": "AI Receptionist Enterprise API", "version": "2.0.0", "docs": "/api/v1/docs", "health": "/api/v1/health"}
